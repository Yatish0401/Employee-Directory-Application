...
const uploadAvPosFiles = async (orderId) => {
  ...
  for (const { file } of avPosSelectedFiles) {
    ...
    try {
      await axios.post('https://employee-directory-application-xzt1.onrender.com/orders/avpos/upload-pod', formData, {
...
const fetchProducts = useCallback(() => {
  axios.get('https://employee-directory-application-xzt1.onrender.com/products')
    .then((res) => {
...
const handleSaveManufacturer = async () => {
  ...
  try {
    if (manufacturerForm.id) {
      await axios.put(`https://employee-directory-application-xzt1.onrender.com/manufacturers/${manufacturerForm.id}`, {
      ...
      await axios.post('https://employee-directory-application-xzt1.onrender.com/manufacturers', {
        name: manufacturerForm.name,
        productType: manufacturerForm.productType
      });
...
useEffect(() => {
  if (activeOrdersPage === 'activity-logs' && user?.id) {
    ...
    axios.delete('https://employee-directory-application-xzt1.onrender.com/activity/cleanup').catch(() => {});

    axios.get(`https://employee-directory-application-xzt1.onrender.com/activity?userId=${user.id}`)
      .then((res) => {
...
// for contry code dropdown and serachable
  ...
  return () => document.removeEventListener('mousedown', handleClickOutside);
    ...
    const fetchRoles = useCallback(() => {
      axios.get('https://employee-directory-application-xzt1.onrender.com/roles')
        .then((res) => {
    ...
    const saveRole = async () => {
      try {
        ...
        await axios.post("https://employee-directory-application-xzt1.onrender.com/roles", {
    ...
    const handleUpdateRole = async () => {
      try {
        ...
        await axios.put(`https://employee-directory-application-xzt1.onrender.com/roles/${editingRole.id}`, {
...
addActivityLog("Updated", "Role Management", permDetails);
  ...
  const fetchUserProfiles = useCallback(() => {
    ...
    axios
      .get(`https://employee-directory-application-xzt1.onrender.com/users`)
      .then((res) => {
    ...
    const fetchUserProfileId = useCallback(async (userId) => {
      try {
        ...
        const res = await axios.get(`https://employee-directory-application-xzt1.onrender.com/users/${userId}/profile`);
  ...
  if (loggedUser) {
    try {
      ...
      const res = await axios.get(`https://employee-directory-application-xzt1.onrender.com/users/${userData.id}/full`);
  ...
  axios.get('https://employee-directory-application-xzt1.onrender.com/manufacturers')
    .then((res) => {
      const data = res.data || [];   // ✅ hamesha latest data use karo
...
useEffect(() => {
  ...
  const BASE    = 'https://employee-directory-application-xzt1.onrender.com';
...
const handleDeleteProduct = async (id) => {
  if (window.confirm("Are you sure you want to delete this product?")) {
    try {
      ...
      await axios.delete(`https://employee-directory-application-xzt1.onrender.com/products/${id}`);
...
const handleSaveProduct = async () => {
  ...
  try {
    ...
    if (editingProductId) {
      ...
      await axios.put(`https://employee-directory-application-xzt1.onrender.com/products/${editingProductId}`, payload);
...
if (productChanges.length > 0) {
  ...
  addActivityLog("Updated", "Product", `Product opened for edit — no changes made`);
      ...
      await axios.post('https://employee-directory-application-xzt1.onrender.com/products', payload);
  ...
  if (window.confirm(`Are you sure you want to delete profile of "${profileName}"?\n\nThis action cannot be undone!`)) {
    axios.delete(`https://employee-directory-application-xzt1.onrender.com/profiles/${id}`).then(() => {
  ...
  setShowEditModal(true);
    ...
    const latestPermissions = selectedRole ? selectedRole.permissions : editingProfile.permissions;
      ...
      await axios.put(`https://employee-directory-application-xzt1.onrender.com/profiles/${editingProfile.id}`, payload);
...
addActivityLog("Updated", "User Management", `Profile updated — ${userChanges.length > 0 ? userChanges.join(", ") : "No changes detected"}`);
  ...
  return;
        ...
        const res = await axios.post(`https://employee-directory-application-xzt1.onrender.com/profiles`, payload, {
...
const fetchItarOrders = useCallback(() => {
  axios.get('https://employee-directory-application-xzt1.onrender.com/orders/itar')
    .then((res) => {
...
const fetchHardwareOrders = useCallback(() => {
  axios.get('https://employee-directory-application-xzt1.onrender.com/orders/hardware')
    .then((res) => {
      const data = res.data || [];
...
const fetchAvPosOrders = useCallback(() => {
  axios.get('https://employee-directory-application-xzt1.onrender.com/orders/avpos')
    .then((res) => {
...
const fetchHardwareSoftwarePosOrders = useCallback(() => {
  axios.get('https://employee-directory-application-xzt1.onrender.com/orders/hwswpos')
    .then((res) => {
  ...
  if (window.confirm("Are you sure you want to delete this ITAR order?")) {
    try {
      ...
      await axios.delete(`https://employee-directory-application-xzt1.onrender.com/orders/itar/${id}`);
 ...
 const handleDeleteHardwareOrder = async (id) => {
  if (window.confirm("Are you sure you want to delete this Hardware order?")) {
    try {
      ...
      await axios.delete(`https://employee-directory-application-xzt1.onrender.com/orders/hardware/${id}`);
...
useEffect(() => {
  if (activeOrdersPage === 'hardware-orders-detail' && selectedHardwareOrder) {
    ...
    axios.get(`https://employee-directory-application-xzt1.onrender.com/warranty/order/${orderId}`)
      .then(res => {
        const loaded = {};
        res.data.forEach(w => {
...
const payload = {
  ...
  return {
    ...
    if (editingAvPosOrderId) {
      ...
      await axios.put(`https://employee-directory-application-xzt1.onrender.com/orders/avpos/${editingAvPosOrderId}`, payload);
      ...
      const createRes = await axios.post('https://employee-directory-application-xzt1.onrender.com/orders/avpos', payload);
...
const handleResetAvPosForm = () => {
  ...
  if (window.confirm("Are you sure you want to delete this AV Pos order?")) {
    try {
      ...
      await axios.delete(`https://employee-directory-application-xzt1.onrender.com/orders/avpos/${id}`);
...
const handleResetHardwareSoftwarePosForm = () => {
  ...
  if (window.confirm("Are you sure you want to delete this Hardware & Software PO?")) {
    try {
      ...
      await axios.delete(`https://employee-directory-application-xzt1.onrender.com/orders/hwswpos/${id}`);
...
const PodFilesSection = ({ order, orderType, setSelectedOrder }) => {
  const uploadUrl  = `https://employee-directory-application-xzt1.onrender.com/orders/${orderType}/${order.id}/pod-files`;
  const refreshUrl = `https://employee-directory-application-xzt1.onrender.com/orders/${orderType}/${order.id}/pod-files`;

  const deleteUrl = (id) => {
    if (orderType === 'avpos')    return `https://employee-directory-application-xzt1.onrender.com/orders/avpos/pod-files/${id}`;
    if (orderType === 'hwswpos')  return `https://employee-directory-application-xzt1.onrender.com/orders/hwswpos/pod-files/${id}`;
    if (orderType === 'hardware') return `https://employee-directory-application-xzt1.onrender.com/orders/hardware/pod-files/${id}`;
    if (orderType === 'itar')     return `https://employee-directory-application-xzt1.onrender.com/orders/itar/pod-files/${id}`;
    return `https://employee-directory-application-xzt1.onrender.com/orders/${orderType}/pod-files/${id}`;
  };
  ...
  const getPreview = (file) => {
    const url  = `https://employee-directory-application-xzt1.onrender.com/uploads/${file.filename}`;
          ...
          {order.pod_files.map((file, fi) => (
            <div key={file.id || fi} style={{ background: "white", borderRadius: "8px", border: "1px solid #e5e7eb", overflow: "hidden", boxShadow: "0 1px 4px rgba(0,0,0,0.06)", display: "flex", flexDirection: "column" }}>
              ...
              <div style={{ padding: "12px 14px", borderTop: "1px solid #f0f0f0", display: "flex", justifyContent: "center", background: "white" }}>
                <a href={`https://employee-directory-application-xzt1.onrender.com/uploads/${file.filename}`}
        ...
        itarPodFiles.map((file, fi) => (
          <div key={file.id || fi} style={{ display: "inline-flex", alignItems: "center", gap: "4px" }}>
            ...
            <button onClick={async () => {
                if (!window.confirm('Delete this POD file?')) return;
                await axios.delete(`https://employee-directory-application-xzt1.onrender.com/orders/itar/pod-files/${file.id}`);
...
<td style={{ padding: "14px 16px" }}>
  ...
  try {
    const podRes = await axios.get(`https://employee-directory-application-xzt1.onrender.com/orders/itar/${order.id}/pod-files`);
    ...
    <div style={{ background: "white", borderRadius: "14px", boxShadow: "0 2px 12px rgba(0,0,0,0.06)", padding: "24px" }}>
      ...
      {(() => {
        ...
        const handleResend = async () => {
          ...
          setSending(true);
          try {
            const res = await fetch('https://employee-directory-application-xzt1.onrender.com/resend-payment-link', {
              method: 'POST',
              headers: { 'Content-Type': 'application/json' },
              body: JSON.stringify({
                email: payEmail,
...
<PodFilesSection order={order} orderType="itar" setSelectedOrder={setSelectedItarOrder} />
  ...
  try {
   ...
   const res = await fetch('https://employee-directory-application-xzt1.onrender.com/tickets', {
      method: 'POST',
      body: formData,       
    });
      ...
      {Array.isArray(hardwarePodFiles) && hardwarePodFiles.length > 0 ? (
        hardwarePodFiles.map((file, fi) => (
          <div key={file.id || fi} style={{ display: "inline-flex", alignItems: "center", gap: "4px" }}>
            ...
            <button onClick={async () => {
                if (!window.confirm('Delete this POD file?')) return;
                await axios.delete(`https://employee-directory-application-xzt1.onrender.com/orders/hardware/pod-files/${file.id}`);
...
<td style={{ padding: "14px 16px" }}>
  ...
  if (Array.isArray(order.items) && order.items.length > 0) {
    ...
    for (const item of order.items) {
      ...
      if (!item.id) continue;
      try {
        const res = await axios.get(`https://employee-directory-application-xzt1.onrender.com/warranty/${item.id}`);
  ...
  try {
    const podRes = await axios.get(`https://employee-directory-application-xzt1.onrender.com/orders/hardware/${order.id}/pod-files`);
...
{(() => {
            ...
            <div style={{ marginBottom: "12px" }}>
              ...
              {existingFiles.map((file, fi) => (
                <div key={file.id || fi} style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "6px", padding: "8px 12px", background: "#f0fdf4", border: "1px solid #bbf7d0", borderRadius: "6px" }}>
                  ...
                  <a
                    href={`https://employee-directory-application-xzt1.onrender.com/uploads/${file.filename}`}
                    target="_blank"
                    rel="noreferrer"
  ...
  try {
    await axios.delete(`https://employee-directory-application-xzt1.onrender.com/orders/avpos/pod-files/${file.id}`);
    ...
    const freshFilesRes = await axios.get(`https://employee-directory-application-xzt1.onrender.com/orders/avpos/${selectedAvPosOrder.id}/pod-files`);
    ...
    {selectedHwSwPosOrder.pod_files.map((file, fi) => (
      <div key={file.id || fi} style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "6px" }}>
        ...
        <button type="button"
          onClick={async () => {
            try {
              await axios.delete(`https://employee-directory-application-xzt1.onrender.com/orders/hwswpos/pod-files/${file.id}`);
...
<div style={{ marginBottom: "20px" }}>
 ...
 onClick={async () => {
  ...
  try {
    const res = await axios.get(`https://employee-directory-application-xzt1.onrender.com/orders/hwswpos/${order.id}/pod-files`);
...
<button type="button" className="action-btn edit-btn"
  onClick={async () => {
    ...
    setSelectedHwSwPosOrder({ ...order, pod_files: [] });
    try {
      const podRes = await axios.get(`https://employee-directory-application-xzt1.onrender.com/orders/hwswpos/${order.id}/pod-files`);
...
<button
  onClick={async () => {
    if (window.confirm(`Delete manufacturer "${m.name}"?`)) {
      try {
        await axios.delete(`https://employee-directory-application-xzt1.onrender.com/manufacturers/${m.id}`);
    ...
    <button
      onClick={() => {
        if (window.confirm(`Delete role "${role.role_name}"?`)) {
          axios.delete(`https://employee-directory-application-xzt1.onrender.com/roles/${role.id}`)
            .then(() => {
              alert("✅ Role deleted!");
