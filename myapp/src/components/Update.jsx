...
function Update() {
        ...
        axios
            ...
            .then((res) => {
                ...
                if (profileData.user_id) {
                    axios
                        .get(`https://employee-directory-application-xzt1.onrender.com/users/${profileData.user_id}/full`)
                        .then((userRes) => {
                            let perms = [];
    ...
    const handleUpdate = (event) => {
        ...
        // Update profile data
        axios
            .put(`https://employee-directory-application-xzt1.onrender.com/profiles/${id}`, {
                name: values.name,
                email: values.email,
                phone: values.phone
            })
            .then((response) => {
                ...
                if (userId) {
                    ...
                    axios
                        .put(`https://employee-directory-application-xzt1.onrender.com/account/${userId}/role-permissions`, {
                            role: values.role,
